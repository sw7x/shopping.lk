                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="col-sm-5 col-md-5 text-center text-sm-left">
                                    <div class="widget">
                                ...
                                <div class="col-sm-3 col-md-3 text-center text-sm-left">
                                    <div class="widget">
                                        <h4 class="widget-title">Help  &amp; Support</h4>
                                        <ul class="links">
                                            <li><a href="about.php">About Us</a></li>
                                            <li><a href="contact.php">Contact Us</a></li>
                                            <li><a href="terms-and-services.php">Terms &amp Services</a></li>
        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    ...
                    <li><a href="https://1.envato.market/DdLk5" target="_blank">Buy shopping.lk!</a></li>
                </ul>
            </nav><!-- End .mobile-nav -->
