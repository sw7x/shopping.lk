...
(function ($) {
  ...
  var Porto = {
    ...
    init: function () {
      ...
      //scrollBtnAppear() // modify
      //filterSlider - price slider
      ...
      /**/  this.scrollToTop();  //OK
      /**/  this.quantityInputs();  // cart Quantity up, down
      /**/  this.changePassToggle(); // modify
      /**/  this.changeBillToggle(); // modify
      //this.catAccordion();
