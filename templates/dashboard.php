        ...
        <main class="main">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 _order-lg-last dashboard-content">                        
                        ...
                        <div class="alert alert-success" role="alert">
                            Hello, <strong>shopping.lk customer!</strong> From your My Account Dashboard you have the ability to view a snapshot of your recent account activity and update your account information. Select a link below to view or edit information.
                        </div>
                        <div class="mb-4"></div>
