...
/* 
ts-node npm-scripts/migrate.ts up     => npm run migrate up
ts-node npm-scripts/migrate.ts status => npm run migrate status
ts-node npm-scripts/migrate.ts down --all => npm run migrate down --all
ts-node npm-scripts/migrate.ts down --last => npm run migrate down --last
*/
