...
import classes from '@containers/shared/ProductAddToCartModal/ProductAddToCartModal.module.css';
import '@containers/shared/ProductAddToCartModal/ProductAddToCartModal.css';
...
export const ProductAddToCartModal: React.FC<ProductAddToCartModalProps> = ({
	isOpen,
	onClose,
	title = 'Add To Cart',
}) => {
	...
	return createPortal(
		<>
			...
			>
				<div className={`${classes['modal-content-wapper']} relative w-auto my-6 mx-auto`}>
					{/*content*/}
					<div
					...
					>
						...
						{/*body*/}
						<div className='modal-body relative px-4 py-3 flex-auto text-2xl text-justify'>
							<ProductFeatrureHorItem isDeal={true} />
						</div>

						{/*footer*/}
						<div
							className={`${classes['modal-footer']} flex items-center justify-end px-5 py-2 border-t border-solid border-blueGray-200 rounded-b`}
						>
							<button
