...
import '@containers/User/PreviouslyBuyItems/PreviouslyBuyItems.css';
import { Pagination } from '@components/Pagination';

const PreviouslyBuyItems = () => {
			...
			<div className='container'>
				<div className='row'>
					...
					<div className='col-lg-9 dashboard-content'>
						<h2 className='step-title mb-2'>Previously Buy Items (34)</h2>
						...
						<div className='previously-buy-items row row-sm'>
							{[...Array(6).keys()].map((key, index) => {
								return <BoughtItem key={index} />;
							})}
						</div>
